...
---
- ### Классы и уровень доступа <a name="1"></a> 
...
```
- ### Конструкторы и деструкторы <a name="2"></a> 
...
```
- ### Наследование конструктора и деструктора <a name="4"></a> 
```c++
class human{
    string name;
    int age;
...
- ### Конструктор копирования и перегрузка оператора "присвоение" <a name="5"></a> 
```c++
...
- ### Конструктор перемещения и перегрузка оператора "присвоение" <a name="7"></a> 
